				...
				if($edge_settings['edge_top_social_icons'] == 0):
				  ...
				  ?><div id="site-branding">
						<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
							<a href="/" title="Retour à la page d'accueil"><div class="flipper">
								<div class="front"><img width="150" height="150" src="../wp-content/uploads/2016/07/cropped-logosite.png" class="custom-logo" alt="Ecusson du club" itemprop="logo" /></div>
								<div class="back"><img width="150" height="150" src="../gclunel.fr/wp-content/uploads/2016/07/cropped-logosite-op.png" class="custom-logo" alt="Ecusson du club" itemprop="logo" /></div>
							</div></a>
						</div>
					</div>
			</div> <!-- end .container -->
...
<?php 
if(is_front_page()){post_carousel_id('5988');}
?>
<!-- Main Page Start ============================================= -->
<div id="content">
<div class="container clearfix">
