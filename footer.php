...
<div class="site-info" <?php if($edge_settings['edge-img-upload-footer-image'] !=''){?>style="background-image:url('<?php echo esc_url($edge_settings['edge-img-upload-footer-image']); ?>');" <?php } ?>>
	...
	<?php
		...
		dynamic_sidebar( 'edge_footer_options' );
			...
			echo '<div class="copyright">Copyright ' .'&copy; ' . date('Y') .' '; ?> - Tous droits réservés au Gallia Club Lunel<br />
		Directeur de la publication : <a href="/contact/">Jean-Pierre Zapata</a> - 
		Site réalisé par <a href="http://www.alexandrealves.fr">Alexandre Alves</a>
			</div>
		<?php endif; ?>
