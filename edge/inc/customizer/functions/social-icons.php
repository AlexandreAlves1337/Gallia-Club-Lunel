...
$wp_customize->add_setting( 'edge_theme_options[edge_social_youtube]', array(
	'default' => $edge_settings['edge_social_youtube'],
	'sanitize_callback' => 'esc_url_raw',
	'type' => 'option',
	'capability' => 'manage_options'
	)
);
$wp_customize->add_control( 'edge_theme_options[edge_social_youtube]', array(
	'priority' => 480,
	'label' => __( 'Youtube Link', 'edge' ),
	'section' => 'edge_social_icons',
	'type' => 'text',
	)
);
$wp_customize->add_setting( 'edge_theme_options[edge_social_vimeo]', array(
	'default' => $edge_settings['edge_social_vimeo'],
	'sanitize_callback' => 'esc_url_raw',
	'type' => 'option',
	'capability' => 'manage_options'
	)
);
$wp_customize->add_control( 'edge_theme_options[edge_social_vimeo]', array(
	'priority' => 480,
	'label' => __( 'Vimeo Link', 'edge' ),
	'section' => 'edge_social_icons',
	'type' => 'text',
	)
);
