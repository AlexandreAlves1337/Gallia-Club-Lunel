...
function edge_social_links() { ?>
	<div class="social-links clearfix">
		...
		if( !empty($edge_settings['edge_social_youtube']) ):
			echo '<a target="_blank" href="'.esc_url($edge_settings['edge_social_youtube']).'"><i class="fa fa-youtube"></i></a>';
		endif;
		if( !empty($edge_settings['edge_social_vimeo']) ):
			echo '<a target="_blank" href="'.esc_url($edge_settings['edge_social_vimeo']).'"><i class="fa fa-vimeo"></i></a>';
		endif;
		if(class_exists('Edge_Plus_Features')){
